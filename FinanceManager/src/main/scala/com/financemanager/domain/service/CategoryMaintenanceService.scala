...
/** Summary used by the UI before deleting a category.
  ...
  * @param assignedTransactionCount
  *   number of transactions currently using the category
  * @param replacementCategoryName
  *   fallback category used when transactions must be preserved
  */
...
/** Coordinates category deletion with transaction reassignment rules.
  ...
  *   source of categories and creation/removal operations
  * @param transactionRepository
  *   repository used to inspect and reassign transactions
  */
final class CategoryMaintenanceService(
  ...
  /** Deletes the category and reassigns dependent transactions to `Unknown`
    * when needed.
    */
